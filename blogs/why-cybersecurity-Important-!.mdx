...
date: 2022-10-27
blogImage: /blogs/why-cybersecurity-Important-!/blogimage.jpg
...
- Phishing Attack: This is the most famous technic to get credentials to form people.
  Hackers can create a webpage that looks like an exact facebook/messenger/Instagram
  login page. They send it to you, and when you put your credentials the hacker gets
  it.
...
- Pwned or not: If your mail &amp; password already leaked by any cyber-attack. You
  should change it as early as possible. you can check if your ID &amp; password leaked
  or not on here https://haveibeenpwned.com/
...
<Image
  src="/blogs/why-cybersecurity-Important-!/you'll be hacked.png"
  width={920}
  height={720}
/>
