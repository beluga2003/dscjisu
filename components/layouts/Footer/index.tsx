    ...
    return (
        <div className=' bg-slate-900  '>
            <div className="footer">
                <div className='grid  grid-cols-3  lg:gap-2 gap-4 text-white  p-10 text-start  lg:place-items-center  '>
                    <div className='sm:col-span-1 col-span-3'>
                        <Image src="/animation_gdsc.webp" height="80" width="90" alt='Google developer Student Club' className='h-[90px]' /> <br />
                        <span className='text-white  font-mono font-medium'>Google Developer Student Club <br /> JIS University</span>
                        <div className='mt-5'>
                            <ul>
                    ...
                    <div className='sm:col-span-1 col-span-3'>
                        ...
                        <div className='mt-5'>
                            <ul className=' text-white font-mono font-medium'>
                                ...
                                <li> <a href="https://www.instagram.com/gdsc_jisu/"><InstagramIcon className='text-white m-2' />@gdsc_jisu</a></li>
                                ...
                                <li>  <a href="https://www.youtube.com/"><YouTubeIcon className='text-white m-2' /></a>@404NotFound</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className='sm:col-span-1 col-span-3'>
                        ...
                        <div className='mt-5'>
                            <ul className=' text-white font-mono font-medium'>
                                <li> <a href="https://www.facebook.com/groups/gdscjisu"><InsertDriveFileIcon className='text-white m-2' />CheatSheets</a></li>
                                <li> <a href="https://www.instagram.com/gdsc_jisu/"><RssFeedIcon className='text-white m-2' />Blogs</a></li>
                                <li>  <a href="https://twitter.com/gdsc_jisu"><PlayCircleIcon className='text-white m-2' /></a>Videos</li>
                                <li>  <a href="https://twitter.com/gdsc_jisu"><FollowTheSignsIcon className='text-white m-2' /></a>RoadMaps</li>
                            </ul>
                        </div>
                    </div>
